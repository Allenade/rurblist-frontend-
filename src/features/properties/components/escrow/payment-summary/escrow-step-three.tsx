...
export default function EscrowStepThree({
  ...
  const termsItems = [
    {
      title: 'Fund Security:',
      content:
        "Buyer's payment is held securely by Rurblist Escrow until property verification is completed.",
    },
    {
      title: 'Verification Process:',
      content:
        'Rurblist conducts checks on ownership documents, land registry records, and property status based on the selected verification plan.',
    },
    {
    ...
    },
    {
      ...
      content:
        "Any disputes arising will be managed by Rurblist's mediation team. Funds remain secured until resolution.",
    },
  ];
  ...
  return (
    <div className="w-full px-4 md:px-0 space-y-10">
      ...
      {/* Terms */}
      <EscrowAgreementCard
        title="Rurblist Escrow Agreement"
        sections={termsItems}
        onDownload={() => {}}
      />
