...
import { useGetMyProperties } from '../../hooks/use-get-my-properties';
import { LoadMoreTrigger } from '@/shared/ui';
import EmptyPropertyState from '../property/list-pr/empty-property';
import PropertyCard from '../property/property-card';
import PropertySkeletonGrid from '../property/property-loader-grid';

export function ListPropertiesPage() {
  const {
    data,
    isLoading,
    error,
