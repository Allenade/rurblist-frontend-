...
import { useGetAgentById } from '@/features/agents/hooks';
import { useParams } from 'next/navigation';
import { useGetAgentPropertiesById } from '@/features/properties/hooks';
...
import AgentProfileInfoSection from './agent-info';
import AgentPropertiesSection from './other-property-agent';
import RatingsSection from './rating-reviews-agent';
