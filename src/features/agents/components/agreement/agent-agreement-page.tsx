...
import { useAgentForm } from '@/features/agents/store';
import { useCreateAgent } from '@/features/agents/hooks';
import { buildAgentPayload } from '@/features/agents/utils';
import toast from 'react-hot-toast';
import { useGetCurrentUser } from '@/features/users/hooks';
import BackNavbar from '../back-navbar';
import SuccessModal from '../modal/create-success-modal';

export function AgentAgreementPage() {
