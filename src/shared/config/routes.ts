export const roles = ['Agent', 'Landlord', 'Home_Seeker', 'Admin'] as const;
...
export const rolePermissions: Record<Role, Permission[]> = {
  ...
  Admin: ['VIEW_DASHBOARD', 'MANAGE_PROPERTIES', 'VIEW_PROFILE', 'MANAGE_USERS'],
};
